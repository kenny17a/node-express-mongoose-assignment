First step: initializing the node package manager in my terminal
second step: installing dependecies such as express and bodyParser
third step: creating my app.js folder where i set up my express, routes, environment variables, server starter
